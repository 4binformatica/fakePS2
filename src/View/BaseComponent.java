...
public class BaseComponent extends JPanel implements MouseListener, MouseMotionListener {
    ...
    private Color backgroundColor; // *Color of the normal bg
    private Color hoverBackgroundColor; // *Color of the bg when is hovered
    private Color borderColor1; // *Color of the top border
    private Color borderColor2; // *Color of the low border
    private boolean isHoverable; // *Do stuff when is hovered
    private boolean isBorderVisible; // *Render the border
    private boolean isRised; // *Is rised by default
    private boolean isInteractive; // *Add all the listeners
    private String imgPath; // *Path of the image to render
    private boolean showImg; // *Has to render an image?
    ...
    public void paint(Graphics g) {
        ...
        if (isBorderVisible) {
            ...
            // 3d design get from:
            // http://www.java2s.com/Tutorials/Java/Swing/Border/Create_a_Solid_3D_border_in_Java.htm
            width--;
            height--;
            if (isRised)
     ...
     * <p>
     * setter method to set the secondary color of the background of the
     * BaseComponent while hovering it
     * </p>
     * 
     * @param newHoverBackgroundColor the new background color when is hovered
     */
     ...
     * <p>
     * getter method to get the secondary color for the background of the
     * BaseComponent while hovering it
     * </p>
     */
     ...
     * <p>
     * setter method to set if the BaseComponent is able change color while it is
     * hovered
     * </p>
     */
     ...
     * <p>
     * getter method to get if the BaseComponent is able change color while it is
     * hovered
     * </p>
     */
